...
public class Variables01 {
    ...
    public static void main(String[] args) {
        ...
        2)short: It is used for numeric values. The minimum value of short is -32,768 and maximum value is 32,767 short
        variables uses 16 bits in memory.
        3) byte: It is used for whole numbers. The minimum value for byte is -128 and maximum value is 127. byte
        variables use 8 bits in memory.
        4)long: It is used for whole numbers. The minimum value for long is -9,223,372,036,854,755,808 and maximum value
        is 9,223,372,036,854,755,808 long variables use 64 bits in memory.
        * Are you sure using long(70000000l)? :)
        ...
        //Note: Java accepts long values as integers in default. But if your value is greater than other maximum value
        //of integers, you will get error and to fix that error you have to put "L" to the end of the numeric value.
        ...
        1)float: It is used for decimal values( like 12.99, 34.89)
         ...
         When you create a float object, you have to use "f or "F" at the end of value.
         ...
         NOTE: float is smaller then double
