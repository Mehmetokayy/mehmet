...
public class TypeCasting01_DT {
    ...
    public static void main(String[] args) {
        ...
        1)Primitive Data Types ===>byte < short < int < long < float < double ==> numeric data types
         ...
         What are the differences between "Primitive Data Types" and "Non-Primitive Data Types"?(Interview question)
         1)Primitive data types have just values but non-Primitive Data Types have values and methods
         2)Primitive Data Types created by Java, we can not create a primitive data type
          But we can create Non-Primitive data types whenever we need.
         3)"Primitive data types uses lowercase in naming convention and Non-Primitive ones uses Upper case naming
          convention.
         4)Usage of memory for primitive data types change from data type to data type. But Non-Primitive data types
          use same amount of memory in heap memory.
        ...
        1)AutoWidening
        Java can put small
        When you put small data type object into large dat types automatically
