...
public class NonPrimitives01 {
       ...
       */
    /*
    When you create a String, Java will check "String Pool" first, if the value you assigned to the String exists in the
    "String Pool" does not have the value you assigned, Java will create a new container.

    2)Sometimes we may need a different container even the values are same. How can we do it?
    "String parentName = new String("Tom Hanks");" definitely creates a new container
    ...
    public static void main(String[] args) {
       ...
       // String parentName = new String(original:"Tom Hanks");
