...
public class StringMnipulations01 {
    public static void main(String[] args) {
        ...
        //Example 01: Type code to find the index of the index of the first occurrence of 'a' a given String
        //    Alabama
        String s = "Alabama";

        //indexOf('a') will give you the indez of first occurrence of 'a'
        ...
        //Example 3:Type code to find the index of the last occurrence of the last occurrence of 'm' in a given String
        //        miami ==> 3;
        String u = "miami";
