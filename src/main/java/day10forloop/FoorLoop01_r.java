...
public class FoorLoop01_r {
    ...
    for( int i =3   ;  i<7    ;   i++){
        ...
        Note 2: If all numbers are integers in a mathematical operation, the result will be in "Integer" data type.
                ...
                57/10 ==> 5            12/5.0 ==>2,4
        Note 3: If you use different data types in mathematical operation, the result will be in the largest data type
                 12/5.0 ==>2.4
                 57.0/10 ==>5.7
                 57/10.0 ==>5.7

         */
         // Ask this question to Ahmet(Yanik Boy)
