     ...
     //         123214 ==> 3+4=7
        ...
        for(int i=0      ; i<num.length()      ; i++     ){
            ...
            if(num.indexOf(ch)==num.lastIndexOf(ch)){
                sumOfUniques = sumOfUniques + Integer.valueOf(ch);//If you put "char" data type inside the "valueOf()" method,
               // it gives you the ASCII value of the char
