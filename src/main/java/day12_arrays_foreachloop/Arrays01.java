...
public class Arrays01 {
  ...
  */
        ...
        System.out.println(sixthGraders); //[Ljava.lang.String;@4dd8dc3 ==>reference of Array.This syntax gives the address of the Array
        ...
        int numOfCharsInFirstIndex=cities[0].length();//5  arrayName[]==> will always return the first element in an array
        ...
        System.out.println(numOfCharsInFirstIndex + numOfCharsInLastIndex);//14
