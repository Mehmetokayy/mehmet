...
public class ArrayLists01 {
    public static void main(String[] args) {
        ...
        //names.removed("Alex"); removes "Alex" from the "names" list
        ...
        //names.removed(2); removes the element "at index 2" from the "names" list
        ...
        //If you put an integer into remove() method parenthesis, Java accepts the integer as "primitive int", if the number you
        //put inside remove() method parenthesis is "primitive int", it will be index.
        //To fix that problem, primitive int to wrapper class by using "(Integer)13"
        boolean isRomoved2 = ages.remove((Integer)13);
        System.out.println(isRomoved2);
        System.out.println(ages);
