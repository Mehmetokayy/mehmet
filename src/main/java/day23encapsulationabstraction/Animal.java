...
public abstract class Animal {
    ...
    1)Sometimes we do not method body, that is why we should not type it.
     If you do not type the "body part" the method will be "method without body" it means it is "abstract method"
    ...
    6)To make method abstract i)Remove method body
