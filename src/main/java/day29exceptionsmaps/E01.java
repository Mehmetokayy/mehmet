...
public class E01 {
 /*
   ...
   What are the differences between "throws" and "throw" keywords?
    ...
    5) "throw" can be used just to throw "RunTimeException", but "throws" can be used to throw both "RunTimeException" or "CompiledTimeException"(Checked Exceptions).

    How to create our own Exceptions Classes
